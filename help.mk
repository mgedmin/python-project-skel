# help.mk version 2.1 (2020-12-01)
#
...
help:
	@grep -Eh -e '^[a-zA-Z0-9_ -]+:.*?##: .*$$' -e '^##:' $(MAKEFILE_LIST) \
	    | awk 'BEGIN {FS = "(^|:[^#]*)##: "; section=""}; \
	          ...
	          /^[^#]/ {split($$1, targets, " "); for (i in targets) { printf "%s\033[36m%-$(HELP_WIDTH)s\033[0m%s%s\n", \
	                   $(HELP_INDENT), $(HELP_PREFIX) targets[i], $(HELP_SEPARATOR), $$2;} section=$(HELP_SECTION_SEP) }'
